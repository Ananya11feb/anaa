...
/*!40101 SET SQL_MODE=''*/training

/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */;
/*!40014 SET @OLD_FOREIGNassignmentemployees_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;
...
/*Table structure for table `customers` *trainingtraining
...
CREATE TABLE `customers` (
  ...
  `contactLastName` varcemployeeshar(50) NOT NULL,
  ...
  CONSTRAINT `customers_ibfk_1`GetCustomers FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees` (`employeeNumber`)
